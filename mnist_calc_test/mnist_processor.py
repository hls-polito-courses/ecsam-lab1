...
#                 prob_thresh=0.0, classification_mask=None):
    def __init__(self, network_graph_filename, core=None,
                 prob_thresh=0.0, classification_mask=None):
        ...
        try:
            ...
            self._net = core.read_network(model=network_graph_filename + ".xml", weights=network_graph_filename + ".bin")
            ...
            self._exec_net = core.load_network(network=self._net, device_name="MYRIAD.1.7-ma2480")
            # self._exec_net = core.load_network(network=self._net, device_name="MYRIAD.1.1-ma2480")
            # self._exec_net = core.load_network(network=self._net, device_name="MYRIAD")
            # self._exec_net = core.load_network(network=self._net, device_name="MYRIAD")
